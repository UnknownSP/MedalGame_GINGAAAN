...
#define IO_SET_TABLE_START()	(D_GPIO_Reset(GPIOB,GPIO_PIN_0))
#define IO_RESET_TABLE_START()	(D_GPIO_Set(GPIOB,GPIO_PIN_0))
#define IO_SET_TABLE_DIR()		(D_GPIO_Set(GPIOA,GPIO_PIN_1))
#define IO_RESET_TABLE_DIR()	(D_GPIO_Reset(GPIOA,GPIO_PIN_1))
#define IO_SET_TABLE_BRAKE()	(D_GPIO_Set(GPIOA,GPIO_PIN_15))
#define IO_RESET_TABLE_BRAKE()	(D_GPIO_Reset(GPIOA,GPIO_PIN_15))
